...
public class Form_info {
	...
	public Form_info(Integer id, String fullname, String adress, String credit_card, Date birthday, String gender,
			...
			String permanent_address, Long sum_price, String room, Integer table, Integer chair, Integer speaker,
			Integer protector, Integer radio) {
		this.id = id;
